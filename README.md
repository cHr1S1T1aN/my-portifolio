...
It is a web application designed to create and manage job opportunities, allowing companies to publish job vacancies and users to view and apply for available positions. The system focuses on simplifying the job posting process and improving accessibility for candidates.
...
(Add frontend techs here if you want, e.g. React, React Native, etc.)
...
about my project:
https://chr1s1t1an.github.io/ladingpage/
